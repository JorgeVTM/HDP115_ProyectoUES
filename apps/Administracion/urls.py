...
urlpatterns = [
    ...
    path('inicio/solicitudlaboral/<int:pk>/view/', views.SolicitudView.as_view(), name='solicitudlaboral_view'),
    ...
    path('inicio/all-solicitudeslaborales', views.SolcitudesAll.as_view(), name='solicitudeslaborales_all'),
    ...
    path('inicio/delete/<int:pk>^/solicitudlaboral/', views.SolicitudDelete.as_view(), name='solicitudlaboral_delete'),
